...
class BookCreate(CreateView):
    model = Book
    fields = ['title', 'author', 'summary', 'genre', 'isbn', 'book_image']
...
def book_delete(request, pk):
    ...
    try:
        ...
        messages.success(request, (book.title + ' cannot be deleted. Copies of this title exist.'))
...
class AvailBooksListView(generic.ListView):
    ...
    def get_queryset(self):
        return BookInstance.objects.filter(status__exact='a').order_by('book')
